...
% título
\title{Testes de hipóteses em Modelos Multivariados \\ de Covariância Linear Generalizada}

% palavras-chave e keywords (p/ resumo, abstract e metadados do PDF)
\pchave{Modelos multivariados de covariância linear generalizada. Testes de hipóteses. Teste Wald. ANOVA. MANOVA.}
\keyword{Multivariate covariance generalized linear models. Hypothesis tests. Wald test. ANOVA. MANOVA.}
...
\include{2-literatura/texto}		% revisão de literatura
\include{3-proposta/texto}			% proposta
\include{4-result/texto}		    % resultados preliminares
